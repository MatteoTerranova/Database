...
('site-inspection','asdas','1'), --consider this as a site-inspection
('planimetry','sas','0'), --consider this as the planimetry done after the site inspection
('technical report','ses','0'), --consider this as the technical report done after site-inspection and planimetry
('drawing','sus','0'); --consider this as the drawing done after the above three ones
...
('c769d3a6-41d1-4883-9edf-e74a977446ad','0',NULL,'2019-08-25','2019-07-25','site-inspection','PlanificationDepartment'),
('7ba08242-0397-4137-9275-e18d8be8ef8e','0','This task needs to be completed 1 week before deadline','2019-10-10','2019-08-10','planimetry','VeficationDepartment'),
('102bcee0-501b-4c63-a5c0-31a82a14a8a5','0',NULL,'2019-04-26','2019-02-15','drawing','ProjectingDepartment'),
('6ef9878a-416e-4782-8e7e-7aa9dd42c140','0','Task to be completed carefully','2019-12-01','2019-09-01','drawing','VeficationDepartment');
...
('planimetry','site-inspection'),
('technical report','planimetry'),
('drawing','technical report');
