 ...
 * @since 1.00
 */
public final class ReadEmployeeDatabase {

	/**
	 * The SQL statement to be executed
	 */
	private static final String STATEMENT = "SELECT badge, surname, age, salary FROM Ferro.Employee WHERE badge = ?";
	 ...
	 */
	public Employee readEmployee() throws SQLException {
