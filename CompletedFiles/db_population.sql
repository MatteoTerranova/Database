...
--Project
INSERT INTO Project(ProjectID, Title, StartDate, EndDate, Location, Quote, Deadline, EstimatedHours) VALUES
('de7c222e-98f0-4eae-b690-7fb37a246bdd','The New House','2018-03-01',NULL,'Padova',??,'2019-12-25',112),
('757ca527-b338-42f5-bbe2-1075d63b492c','New Project','2019-08-15','2020-09-05','Roma',??,'2020-09-05',80),
('866adc89-5a04-463b-82a3-3bf0ad77491b','Company Building','2018-04-26','2021-04-01','Venezia',??,'2021-06-06',1600);
...
('bf44a0cb-3aad-4aa4-8282-17bae578e1d2',??,'1'), --consider this as a site-inspection
('4dc57b44-1734-415f-935b-6dac0f812d7d',??,'0'), --consider this as the planimetry done after the site inspection
('f45d74ee-2e30-4f09-a4ae-37df7102f65a',??,'0'), --consider this as the technical report done after site-inspection and planimetry
('02cc96bb-5276-42d7-82e4-ff262aa60efd',??,'0'); --consider this as the drawing done after the above three ones
...
('c769d3a6-41d1-4883-9edf-e74a977446ad','0',NULL,'2019-08-25','2019-07-25','bf44a0cb-3aad-4aa4-8282-17bae578e1d2','Take-Over'),
('7ba08242-0397-4137-9275-e18d8be8ef8e','0','This task needs to be completed 1 week before deadline','2019-10-10','2019-08-10','4dc57b44-1734-415f-935b-6dac0f812d7d','Computations'),
('102bcee0-501b-4c63-a5c0-31a82a14a8a5','0',NULL,'2019-04-26','2019-02-15','02cc96bb-5276-42d7-82e4-ff262aa60efd','Design');
('6ef9878a-416e-4782-8e7e-7aa9dd42c140','0','Task to be completed carefully','2019-12-01','2019-09-01','02cc96bb-5276-42d7-82e4-ff262aa60efd','Design 2D');
